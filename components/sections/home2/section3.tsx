					...
					<div className="counter-wrap2">
						...
						<div className="row gy-60 justify-content-xl-between justify-content-center">
							<div className="col-xl-auto col-lg-6">
								<div className="counter-card2">
									<div className="box-icon">
										<LazyImg src="/assets/img/icon/counter-icon2-1.svg" alt="img" />
									</div>
							...
							<div className="col-xl-auto col-lg-6">
								<div className="counter-card2">
									<div className="box-icon">
										<LazyImg src="/assets/img/icon/counter-icon2-2.svg" alt="img" />
									</div>
									<div className="box-content">
							...
							<div className="col-xl-auto col-lg-6">
								<div className="counter-card2">
									<div className="box-icon">
										<LazyImg src="/assets/img/icon/counter-icon2-3.svg" alt="img" />
									</div>
									<div className="box-content">
