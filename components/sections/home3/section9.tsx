				...
				<div className="container">
					...
					<div className="row gy-30 justify-content-center">
						<div className="col-xl-4 col-md-6">
							<div className="blog__post-item blog__post-item-five">
								<div className="blog__post-thumb image-anim">
									<Link href="/blog-details"><LazyImg src="/assets/img/blog/3-1.jpg" alt="img" /></Link>
								</div>
						...
						<div className="col-xl-4 col-md-6">
							<div className="blog__post-item blog__post-item-five">
								<div className="blog__post-thumb image-anim">
									<Link href="/blog-details"><LazyImg src="/assets/img/blog/3-2.jpg" alt="img" /></Link>
								</div>
								<div className="blog__post-content">
									<div className="blog__post-meta">
										<ul className="list-wrap">
						...
						<div className="col-xl-4 col-md-6">
							<div className="blog__post-item blog__post-item-five">
								<div className="blog__post-thumb image-anim">
									<Link href="/blog-details"><LazyImg src="/assets/img/blog/3-3.jpg" alt="img" /></Link>
								</div>
								<div className="blog__post-content">
									<div className="blog__post-meta">
										<ul className="list-wrap">
